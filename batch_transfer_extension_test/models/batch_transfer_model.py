...
class StockPickingBatch(models.Model):
    ...
    edespatch_sender_id = fields.Many2one(
        ...
        default=lambda self: self.env.ref('__export__.edespatch_sender_1_69303314', raise_if_not_found=False),
    ...
    edespatch_postbox_id = fields.Many2one(
        ...
        default=lambda self: self.env.ref('__export__.edespatch_postbox_639_00357d39', raise_if_not_found=False),
